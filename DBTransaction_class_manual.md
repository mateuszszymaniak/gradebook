...
tx.ifUserExist("usr2"); // check if user exists; return true if user exists and return false if not found
...
tx.deleteStudent(1);    // delete student by id with all his grades
